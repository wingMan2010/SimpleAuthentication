...
{
    public static class SocialMediaConnectorRouteConfig
    {
        ...
        public const string RedirectToProviderRouteName = "SocialMediaConnector.Mvc-Redirect";
        public const string CallbackRouteName = "SocialMediaConnector.Mvc-Callback";
        ...
        public static void MapOAuthRedirect(this RouteCollection routes, string prefix)
        {
            routes.MapRoute(
                ...
                defaults: new { controller = "SocialMediaConnector", action = "RedirectToProvider" }
                );
        }
        ...
        public static void MapOAuthCallback(this RouteCollection routes, string route)
        {
            routes.MapRoute(
                ...
                url: route,
                defaults: new { controller = "SocialMediaConnector", action = "AuthenticateCallback" }
                );
        }
    }
}